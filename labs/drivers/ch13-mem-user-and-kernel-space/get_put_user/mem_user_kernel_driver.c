 ...
 *
 * - How to use get_user() and put_user().
 ...
 *
 * pi@raspberrypi:~ $ sudo insmod mem_user_kernel_driver.ko
 * pi@raspberrypi:~ $ ls /dev/memuserkernel101
 * pi@raspberrypi:~ $ sudo chmod 666 /dev/memuserkernel101
 * pi@raspberrypi:~ $ echo gato > /dev/memuserkernel101
 * pi@raspberrypi:~ $ cat /dev/memuserkernel101
...
MODULE_AUTHOR("John");
MODULE_DESCRIPTION("Misc device, how to use get_user() and put_user()");
